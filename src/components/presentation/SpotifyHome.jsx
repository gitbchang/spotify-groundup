...
class SpotifyHome extends Component {
  render() {
    return (
      <nav className="db dt-l w-100 border-box pa5 ph7-l bg-black z-5 shadow-1">
        ...
        <div className="db dtc-l v-mid w-100 w-75-l tc tr-l">
          <a className="link white f6 f5-l dib mr3 mr4-l hover-hot-pink" href="/login" title="Data Visuals">Spotify Login</a>
